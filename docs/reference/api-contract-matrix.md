...
Generated from 189 operations: 189 precise, 0 broad.
...
| GET | /v1/admin/outbox | outboxOperatorDiagnostics | Bearer | instance:admin | - | - | - | 200:application/json:OutboxDiagnosticsEnvelope | precise | experimental |
| POST | /v1/admin/outbox/{id}/replay | replayTerminalOutboxJob | Bearer | instance:admin | required | path:id | application/json:EmptyObject | 200:application/json:OutboxReplayEnvelope | precise | experimental |
...
| POST | /v1/sboms/spdx | uploadSPDXSBOM | Bearer | evidence:write | required | header:X-Evydence-Artifact-ID, header:X-Evydence-Release-ID | application/json:UploadSPDXSBOMRequest, application/spdx+json:string/binary | 201:application/json:SBOMEnvelope | precise | core |
...
| POST | /v1/vulnerability-scans | uploadVulnerabilityScan | Bearer | evidence:write | required | - | application/json:UploadVulnerabilityScanBody | 201:application/json:VulnerabilityScanEnvelope | precise | core |
