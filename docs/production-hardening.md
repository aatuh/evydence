...
- Signing operations use either a tenant-controlled HTTPS signing gateway or the AWS KMS executor; raw evidence payload bytes are not sent to either executor by Evydence.
