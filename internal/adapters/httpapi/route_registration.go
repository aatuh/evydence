...
func (s *Server) productReleaseRoutes() []routeDef {
	return []routeDef{
		...
		{http.MethodGet, "/v1/releases/{id}/security-summary", op("releaseSecuritySummary", http.MethodGet, "/v1/releases/{id}/security-summary", "Release security summary", []string{app.ScopeReportRead}), http.HandlerFunc(s.releaseSecuritySummary)},
...
func (s *Server) packagePortalRoutes() []routeDef {
	return []routeDef{
		...
		{http.MethodGet, "/v1/customer-portal/access", op("listCustomerPortalAccess", http.MethodGet, "/v1/customer-portal/access", "List customer portal access records", []string{app.ScopePackageRead}), http.HandlerFunc(s.listCustomerPortalAccess)},
		{http.MethodPost, "/v1/customer-portal/access/{id}/revoke", op("revokeCustomerPortalAccess", http.MethodPost, "/v1/customer-portal/access/{id}/revoke", "Revoke customer portal access", []string{app.ScopePackageWrite}), http.HandlerFunc(s.revokeCustomerPortalAccess)},
		...
		{http.MethodGet, "/v1/customer-portal/package/view", op("customerPortalPackageViewForm", http.MethodGet, "/v1/customer-portal/package/view", "Customer portal package review form", nil), http.HandlerFunc(s.customerPortalPackageViewForm)},
		{http.MethodPost, "/v1/customer-portal/package/view", op("customerPortalPackageView", http.MethodPost, "/v1/customer-portal/package/view", "Customer portal package review page", nil), http.HandlerFunc(s.customerPortalPackageView)},
		{http.MethodPost, "/v1/customer-portal/package/view/download", op("downloadCustomerPortalPackageView", http.MethodPost, "/v1/customer-portal/package/view/download", "Download customer portal package ZIP from review form", nil), http.HandlerFunc(s.downloadCustomerPortalPackageView)},
		...
		{http.MethodPost, "/v1/questionnaire-answer-library", op("createQuestionnaireAnswerLibraryEntry", http.MethodPost, "/v1/questionnaire-answer-library", "Create questionnaire answer library entry", []string{app.ScopePackageWrite}), http.HandlerFunc(s.createQuestionnaireAnswerLibraryEntry)},
		{http.MethodGet, "/v1/questionnaire-answer-library", op("listQuestionnaireAnswerLibrary", http.MethodGet, "/v1/questionnaire-answer-library", "List questionnaire answer library entries", []string{app.ScopePackageRead}), http.HandlerFunc(s.listQuestionnaireAnswerLibrary)},
...
func (s *Server) evidenceRiskPolicyRoutes() []routeDef {
	return []routeDef{
		...
		{http.MethodPost, "/v1/vex/preview", readOnlyPostOp("previewVEXImport", http.MethodPost, "/v1/vex/preview", "Preview OpenVEX import", []string{app.ScopeEvidenceRead}), http.HandlerFunc(s.previewVEXImport)},
		...
		{http.MethodPost, "/v1/vex/cyclonedx/preview", readOnlyPostOp("previewCycloneDXVEXImport", http.MethodPost, "/v1/vex/cyclonedx/preview", "Preview CycloneDX VEX import", []string{app.ScopeEvidenceRead}), http.HandlerFunc(s.previewCycloneDXVEXImport)},
		...
		{http.MethodGet, "/v1/vulnerability-decisions", op("listVulnerabilityDecisions", http.MethodGet, "/v1/vulnerability-decisions", "List vulnerability decisions", []string{app.ScopeEvidenceRead}), http.HandlerFunc(s.listVulnerabilityDecisions)},
		...
		{http.MethodGet, "/v1/reports/vulnerability-decision-summary", op("vulnerabilityDecisionSummaryReport", http.MethodGet, "/v1/reports/vulnerability-decision-summary", "Customer-safe vulnerability decision summary", []string{app.ScopeReportRead}), http.HandlerFunc(s.vulnerabilityDecisionSummaryReport)},
