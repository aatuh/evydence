...
const en: Record<PageKey, PageContent> = {
  home: {
    ...
    sections: [
      ...
      },
      {
        ...
        table: [
          {
            left: "Evidence scattered across tools",
            right: "Evidence linked to a release",
          },
          {
            left: "Manual customer answers",
            right: "Repeatable customer package",
          },
          {
            left: "Decisions hidden in tickets or chat",
            right: "Decision trail with actor context",
          },
          {
            left: "Hard to explain not affected",
            right: "Reviewable vulnerability decision",
          },
          {
            left: "One-off PDF work",
            right: "Package generated from structured records",
          },
        ],
      },
      {
  ...
  customerReview: {
    ...
    description:
      "Turn customer security review questions into a repeatable release evidence workflow.",
    eyebrow: "Use case",
        ...
        table: [
          {
            ...
            right:
              "For this release, the finding was reviewed, marked not affected, linked to supporting evidence, and included in the customer-safe package.",
          },
        ],
      },
    ],
  ...
  commercial: {
    ...
    description:
      "Commercial self-hosted licensing, async support, deployment review, and integration support.",
    ...
    sections: [
      {
        ...
        table: [
          {
            left: "Public AGPL license",
            right: "Separate written commercial agreement",
          },
          { left: "Public GitHub issues", right: "Private async support" },
          {
            left: "Best-effort community help",
            right: "Agreed support and upgrade path",
          },
          {
            left: "Self-evaluation",
            right: "Optional deployment-readiness review",
          },
          {
            left: "AGPL obligations apply",
            right: "Extra permission for agreed use cases",
          },
        ],
      },
      {
        ...
        cards: [
          {
            title: "Commercial Self-Hosted License",
            body: "Private commercial terms, procurement-friendly licensing, and an agreed support path.",
          },
          {
            title: "Async Support",
            body: "Private written support for troubleshooting, upgrade planning, deployment questions, and release evidence workflows.",
          },
          {
            title: "Deployment Readiness Review",
            body: "Written review of configuration, backup/restore, evidence handling, deployment architecture, and known limitations.",
          },
          {
            title: "Release Evidence Package Review",
            body: "Written review of one evidence package, including gaps, assumptions, limitations, and customer-safe sharing concerns.",
          },
          {
            title: "Custom Integration",
            body: "Collector adapters, evidence workflows, report templates, CI/CD integration, or deployment hardening.",
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        table: [
          ...
          {
            left: "Controlled internal self-hosted use",
            right: "Candidate after review",
          },
          { left: "Regulated production", right: "Requires extra review" },
          {
            left: "Air-gapped production",
            right: "Requires transfer controls",
          },
  ...
  glossary: {
    ...
    description:
      "Plain-English terms for release evidence, SBOMs, CVEs, VEX, and customer-safe packages.",
    eyebrow: "Resources",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Evidence",
            body: "Proof material around a software release: scan results, component lists, build records, vulnerability decisions, approvals, artifact hashes, release reports, and customer-safe files.",
          },
          {
            title: "Evidence package",
            body: "An organized bundle of release proof that can be reviewed internally or shared with a customer.",
          },
          {
            title: "SBOM",
            body: "A software ingredients list. It describes the components used inside software.",
          },
          {
            title: "CVE",
            body: "A public identifier for a known software flaw.",
          },
          {
            title: "VEX",
            body: "A structured way to explain whether a known vulnerability actually affects a specific product or release.",
          },
          {
            title: "Customer-safe package",
            body: "A package that contains useful review evidence without exposing unnecessary internal details.",
          },
          {
            title: "Release readiness",
            body: "A structured view of whether the release has expected evidence, decisions, approvals, and known limitations before it is shared or shipped.",
          },
        ],
      },
    ],
  ...
  cra: {
    ...
    description:
      "Technical evidence organization for CRA-readiness work without legal compliance claims.",
    eyebrow: "Resources",
  ...
  contact: {
    ...
    title: "Contact",
    navTitle: "Contact",
    metaTitle: "Contact - Evydence",
    description:
      "Start a commercial self-hosted conversation through LinkedIn.",
    eyebrow: "LinkedIn contact",
    heroTitle: "Start a commercial conversation.",
    heroBody: [
      "Use LinkedIn for an initial commercial self-hosted conversation, deployment assumptions, release workflow notes, or commercial licensing questions.",
    ],
    primaryCta: "Open LinkedIn profile",
    secondaryCta: "View GitHub",
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          "Do not send raw evidence payloads, bearer tokens, private keys, database URLs, customer data, or unreleased package contents through LinkedIn or any public contact path.",
          "Use the first message only for brief, non-sensitive context. A safer private channel can be agreed separately if needed.",
        ],
      },
    ],
  },
...
const fi: Record<PageKey, PageContent> = {
  home: {
    ...
    sections: [
      ...
      },
      {
        ...
        table: [
          {
            left: "Evidence on hajallaan työkaluissa",
            right: "Evidence on linkitetty julkaisuun",
          },
          {
            left: "Asiakasvastaukset ovat käsityötä",
            right: "Asiakaspaketti voidaan toistaa",
          },
          {
            left: "Päätökset ovat piilossa tiketeissä tai chatissa",
            right: "Päätöspolku sisältää tekijäkontekstin",
          },
          {
            left: "Not affected -päätöstä on vaikea selittää",
            right: "Haavoittuvuuspäätös on katselmoitavissa",
          },
          {
            left: "PDF-työ tehdään kertaluonteisesti",
            right: "Paketti syntyy rakenteisista tietueista",
          },
        ],
      },
      {
  ...
  product: {
    ...
    sections: [
      ...
      {
        title: "Tallenna haavoittuvuuspäätökset",
        body: [
  ...
  customerReview: {
    ...
    description:
      "Muuta asiakkaan tietoturvakysymykset toistettavaksi julkaisuevidence-työnkuluksi.",
    ...
    sections: [
      {
        title: "Kysymys, joka käynnistää selvityksen",
        body: [
      ...
      },
      {
        ...
        table: [
          {
            left: "Uskomme, ettei tämä ole hyödynnettävissä. Tarkistamme asian kehitystiimiltä.",
            right:
              "Tälle julkaisulle löydös arvioitiin, merkittiin not affected -tilaan, linkitettiin tukevaan evidenceen ja sisällytettiin asiakaspakettiin.",
          },
        ],
      },
    ],
  ...
  releasePackage: {
    ...
    sections: [
      {
        title: "Suositeltu sisältö",
        bullets: [
          "tuotteen ja julkaisun identiteetti",
          "toimitettujen artefaktien viitteet",
          "artefaktien tiivisteet tai digestit",
          "SBOM/komponentti-inventaario",
          "haavoittuvuusskannauksen yhteenveto",
          "haavoittuvuuspäätökset",
          "poikkeus- tai waiver-tietueet",
          "koonti- ja lähdekoodiprovenanssi",
          "hyväksyntäpolku",
          "pakettimanifesti",
          "rajoitukset ja oletukset",
          "asiakkaalle turvalliset redaktiot",
        ],
      },
      {
        title: "Tärkeä raja",
        body: [
          "Paketti ei tarkoita, että julkaisu olisi täydellisen turvallinen.",
          "Se tarkoittaa, että tiimi voi näyttää, mitä tarkistettiin, mitä päätettiin, mitä on yhä tuntematonta ja mikä evidence tukee vastausta.",
        ],
      },
    ],
  },
  commercial: {
    ...
    description:
      "Kaupallinen itse ylläpidettävä lisensointi, async-tuki, käyttöönottokatselmus ja integraatiotuki.",
    eyebrow: "Commercial Self-Hosted",
    ...
    sections: [
      {
        ...
        table: [
          {
            left: "Julkinen AGPL-lisenssi",
            right: "Erillinen kirjallinen kaupallinen sopimus",
          },
          { left: "Julkiset GitHub-issuet", right: "Yksityinen async-tuki" },
          {
            left: "Best-effort-yhteisöapu",
            right: "Sovittu tuki- ja päivityspolku",
          },
          {
            left: "Oma arviointi",
            right: "Valinnainen deployment readiness -katselmus",
          },
          {
            left: "AGPL-velvoitteet pätevät",
            right: "Lisälupa sovittuihin käyttötapauksiin",
          },
        ],
      },
      {
        title: "Maksulliset vaihtoehdot",
        cards: [
          {
            title: "Commercial Self-Hosted License",
            body: "Yksityiset kaupalliset ehdot, hankintaystävällinen lisensointi ja sovittu tukipolku.",
          },
          {
            title: "Async Support",
            body: "Yksityinen kirjallinen tuki vianrajoitukseen, päivityssuunnitteluun, käyttöönottokysymyksiin ja julkaisuevidence-työnkulkuihin.",
          },
          {
            title: "Deployment Readiness Review",
            body: "Kirjallinen katselmus konfiguraatiosta, varmistuksista, evidencen käsittelystä, arkkitehtuurista ja tunnetuista rajoituksista.",
          },
          {
            title: "Release Evidence Package Review",
            body: "Kirjallinen katselmus yhdestä evidence-paketista, mukaan lukien aukot, oletukset, rajoitukset ja asiakkaalle turvallinen jakaminen.",
          },
          {
            title: "Custom Integration",
      ...
      {
        title: "Kaupallinen raja",
        body: [
          "Kaupalliset ehdot eivät tee Evydencestä juridista vaatimustenmukaisuustakuuta, tietoturvasertifiointia, haavoittuvuusskanneria tai hallittua SaaS-palvelua.",
        ],
      },
    ],
  },
  status: {
    ...
    sections: [
      {
        title: "Käyttöprofiilin sopivuus",
        table: [
          { left: "Paikallinen tekninen arviointi", right: "Hyvä sopivuus" },
          {
            left: "Pilotti yhdellä tuotteella/julkaisulla",
            right: "Hyvä sopivuus",
          },
          {
            left: "Hallittu sisäinen itse ylläpidettävä käyttö",
            right: "Kandidaatti katselmuksen jälkeen",
          },
          { left: "Reguloitu tuotanto", right: "Vaatii lisäkatselmuksen" },
          { left: "Air-gapped-tuotanto", right: "Vaatii siirtokontrollit" },
          {
            left: "Evydencen hostattu SaaS",
            right: "Ei tällä hetkellä tarjolla",
          },
        ],
      },
      {
        ...
        body: [
          "Tämä sivu suodattaa huonosti sopivat käyttötapaukset ja lisää luottamusta sopivien arvioijien kanssa kertomalla rajoitukset suoraan.",
        ],
      },
    ],
  },
  glossary: {
    ...
    description:
      "Selkokieliset termit julkaisuevidencestä, SBOMeista, CVE-tunnuksista, VEXistä ja asiakaspaketeista.",
    eyebrow: "Resurssit",
    ...
    sections: [
      {
        ...
        cards: [
          {
            title: "Evidence",
            body: "Julkaisun ympärillä oleva todistusaineisto: skannaustulokset, komponenttilistat, koontitietueet, haavoittuvuuspäätökset, hyväksynnät, artefaktitiivisteet, julkaisuraportit ja asiakkaalle turvalliset tiedostot.",
          },
          {
            title: "Evidence-paketti",
            body: "Järjestetty julkaisun todistusaineistopaketti, jota voidaan katselmoida sisäisesti tai jakaa asiakkaalle.",
          },
          {
            title: "SBOM",
            body: "Ohjelmiston ainesosalista. Se kuvaa ohjelmistossa käytetyt komponentit.",
          },
          {
            title: "CVE",
            body: "Julkinen tunniste tunnetulle ohjelmistovirheelle.",
          },
          {
            title: "VEX",
            body: "Rakenteinen tapa selittää, vaikuttaako tunnettu haavoittuvuus tiettyyn tuotteeseen tai julkaisuun.",
          },
          {
            title: "Asiakkaalle turvallinen paketti",
            body: "Paketti, joka sisältää hyödyllisen katselmusevidencen paljastamatta tarpeettomia sisäisiä yksityiskohtia.",
          },
          {
            title: "Julkaisuvalmius",
            body: "Rakenteinen näkymä siihen, onko julkaisulla odotettu evidence, päätökset, hyväksynnät ja tunnetut rajoitukset ennen jakamista tai toimitusta.",
          },
        ],
      },
    ],
  ...
  cra: {
    ...
    metaTitle:
      "Teknisen evidencen järjestäminen CRA-valmiutta varten - Evydence",
    description:
      "Teknisen evidencen järjestäminen CRA-valmiustyöhön ilman juridisia vaatimustenmukaisuusväitteitä.",
    eyebrow: "Resurssit",
    ...
    sections: [
      {
        title: "Varovainen sanamuoto",
        body: [
          "Evydence voi tukea CRA-valmiustyötä auttamalla tiimejä säilyttämään julkaisutason teknistä evidenceä, haavoittuvuuspäätöksiä, SBOM-tietueita, pakettimanifesteja ja tunnettuja rajoituksia.",
        ],
      },
      {
        title: "Vältettävät sanamuodot",
        bullets: [
          "Evydence tekee sinusta CRA-yhteensopivan.",
          "Evydence sertifioi julkaisusi.",
          "Evydence takaa viranomaisen hyväksynnän.",
          "Evydence todistaa, että ohjelmistosi on turvallinen.",
        ],
      },
    ],
  },
  contact: {
    ...
    title: "Yhteys",
    navTitle: "Yhteys",
    metaTitle: "Yhteys - Evydence",
    description: "Aloita Commercial Self-Hosted -keskustelu LinkedInissä.",
    eyebrow: "LinkedIn-yhteys",
    heroTitle: "Aloita kaupallinen keskustelu.",
    heroBody: [
      "Käytä LinkedIniä ensimmäiseen Commercial Self-Hosted -keskusteluun, käyttöoletuksiin, julkaisutyönkulun muistiinpanoihin tai lisensointikysymyksiin.",
    ],
    primaryCta: "Avaa LinkedIn-profiili",
    secondaryCta: "Avaa GitHub",
    sections: [
      {
        title: "Mitä mukaan",
        bullets: [
          "suunniteltu käyttötapa",
          "tavoiteltu käyttöönottomalli",
          "AGPL- tai kaupalliset huolenaiheet",
          "tukiodotukset",
          "tavoiteltu julkaisutyönkulku",
          "toivottu seuraava askel",
        ],
      },
      {
        title: "Älä lähetä arkaluonteista evidenceä",
        body: [
          "Älä lähetä raw evidence -payloadia, bearer-tokeneita, yksityisiä avaimia, tietokanta-URL-osoitteita, asiakasdataa tai julkaisemattomia pakettisisältöjä LinkedInin tai muun julkisen yhteyspolun kautta.",
          "Käytä ensimmäistä viestiä vain lyhyeen, ei-arkaluonteiseen kontekstiin. Turvallisempi yksityinen kanava voidaan sopia erikseen tarvittaessa.",
        ],
      },
    ],
  },
  privacyCookies: {
    ...
    description:
      "Miten markkinointisivusto käsittelee välttämättömiä asetuksia ja valinnaista mittausta.",
    eyebrow: "Yksityisyys",
    ...
    sections: [
      {
        title: "Mitä voidaan mitata hyväksynnän jälkeen",
        bullets: [
          "sivunäkymät",
          "ulospäin lähtevät GitHub-klikkaukset",
          "dokumentaatioklikkaukset",
          "yhteydenottoklikkaukset",
          "kielenvaihdot",
        ],
      },
      {
        title: "Mitä ei mitata",
        body: [
          "Sivusto ei saa seurata lomakkeen raakatekstiä, sähköpostiosoitteita, asiakkaiden nimiä, yritysten nimiä, evidence-pakettien dataa, tokeneita, salaisuuksia sisältäviä kyselyparametreja tai tukisisältöä.",
        ],
      },
      {
        title: "Valinnan muuttaminen",
        body: [
          "Avaa suostumuspaneeli uudelleen alatunnisteen evästeasetusten linkistä ja muuta valinnaisen mittauksen valintaa.",
        ],
      },
    ],
  },
...
export const ui = {
  en: {
    ...
    contactHref: externalLinks.linkedin,
  },
  fi: {
    ...
    github: "GitHub",
    footerTagline:
      "Itse ylläpidettävä julkaisuevidence ohjelmistotoimittajille.",
    footerBoundary:
...
export function staticPages(): Array<{
  locale: Locale;
  pageKey: PageKey;
